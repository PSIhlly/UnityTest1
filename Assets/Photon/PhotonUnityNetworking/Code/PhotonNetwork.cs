...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        public const string ServerSettingsFileName = "PUN/PhotonServerSettings";
        ...
        private static int serializationFrequency = 33; // in milliseconds. I.e. 100 = 100ms which makes 10 times/second
        ...
        public static bool RaiseEvent(byte eventCode, object eventContent, RaiseEventOptions raiseEventOptions, SendOptions sendOptions)
        {
            ...
            {
                return RaiseEventInternal(eventCode, eventContent, raiseEventOptions, sendOptions);
            }
        ...
        public static GameObject NetworkInstantiate(Pun.InstantiateParameters parameters, bool roomObject = false, bool instantiateEvent = false, GameObject instantiated = null)
        {
        ...
        public static bool SendInstantiate(Pun.InstantiateParameters parameters, bool roomObject = false)
        {
        ...
        public static void LoadOrCreateSettings(bool reload = false)
        {
            ...
            photonServerSettings = Resources.Load<ServerSettings>(PhotonNetwork.ServerSettingsFileName);
            if (photonServerSettings != null)
            {
                return;
            }
